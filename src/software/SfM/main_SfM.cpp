...
int main(int argc, char **argv)
{
  ...
  double translation_averaging_multiplier = 4.0;
  double translation_averaging_weight = 10.0;
  ...
  cmd.add( make_option('v', translation_averaging_multiplier, "translationAveragingMultiplier") );
  cmd.add( make_option('w', translation_averaging_weight, "translationAveragingWeight") );
  // Stellar SfM
  ...
  try {
    ...
    OPENMVG_LOG_INFO << "Usage: " << argv[0] << '\n'
      ...
      << "\t[-v|--translationAveragingMultiplier] Scaling factor for translation constraints (default: 4.0)\n"
      << "\t[-w|--translationAveragingWeight] Weight for translation constraints (default: 10.0)\n"
      << "[STELLAR]\n"
  ...
  case ESfMEngine::GLOBAL:
  {
    ...
    engine->SetTranslationAveragingConstraints(
      translation_averaging_multiplier,
      translation_averaging_weight);
